...
export const OfferLookup = ({id, title, description, address, date, created_at, view = f => f, edit = f => f, closeMenu, user, user_id}) => {
            ...
            <div className="content shadow p-0 col-10 mb-5">
                ...
                <div className="work-option-content row m-0 justify-content-center">
                    ...
                    <p className="work-option-description col-11 text-center">
                        ...
                        <a className="colorful-text" onClick={() => {view(id); closeMenu();}}>... Zisti viac.</a>
                    </p>
