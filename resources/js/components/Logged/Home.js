...
export const Home =({edit = f => f, region, createAd = f => f, updateAd = f =>f}) => {
    ...
    const showAdvertisementInfo = () => {
        ...
        $("#advertisement-info").show();
    };
    const hideAdvertisementInfo = () => {
        //setCreate({id: id, active: true});
        $("#advertisement-info").hide();
    };
                                ...
                                <div className={"col-12 row justify-content-center py-5"}>
                                    ...
                                    <div className={"col-12 col-sm-4 order-1 order-sm-2 "}>
                                        <div className={"cross float-right float-sm-none"}>
                                            <svg onClick={()=> hideAdvertisementInfo()} className="ml-3" style={{transform:"scale(.8)"}} width="42" height="42" viewBox="0 0 42 42"><path d="M42,2.467,23.467,21,42,39.534,39.533,42,21,23.468,2.467,42,0,39.534,18.533,21,0,2.467,2.467,0,21,18.534,39.533,0Z" transform="translate(0 -0.001)" fill="#2c393f"/></svg>
                                        </div>
                                    </div>
                                    ...
                                    <div className="row justify-content-center order-3 order-md-4">
                                        <div className="col-md-8 order-4 order-m-3">
                                            <div className={"border-r pt-4 justify-content-center row "}>
                                                ...
                                                Donec convallis iaculis tellus vel interdum. Maecenas dictum dui sed urna condimentum lacinia. In suscipit metus vel tempor rhoncus. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed ac vestibulum felis. Mauris commodo porttitor scelerisque. Duis et metus at quam convallis dapibus a ut metus.
                                                </p>
