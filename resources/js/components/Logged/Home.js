...
export const Home =({ additional, offers, offer, user, updateProfile = f => f, createOffers = f => f, updateOffers = f => f, viewOffers = f => f, closeOffers = f => f, signOut }) => {
