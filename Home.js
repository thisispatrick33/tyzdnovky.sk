...
export const Home =({ additional, offers, offerSize, offer, user, updateProfile = f => f, createOffer = f => f, updateOffer = f => f, viewOffer = f => f, closeOffer = f => f, signOut, clearOffer }) => {
